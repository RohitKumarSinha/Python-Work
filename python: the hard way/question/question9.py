...
from question10 import *


class question_nine(question_ten):

    def enter(self):
        print(dedent("""
        Here is your nine question .
        Q9. who holds the guinness whole record
        for the oldest person to be elected for
        the first time as a PM of a nation .

        1. Morarji Desai                       2. chaudhary charan singh
        3. p v narasimha                       4. H D Deve Gowda
