...
from exercise14 import *


class question_thirteen(question_fourteen):

    def enter(self):
        print(dedent("""
        Here is your thirteen question .
        Q13. How many capital cities of indian
        states contain the word Nagar in their
        names .
