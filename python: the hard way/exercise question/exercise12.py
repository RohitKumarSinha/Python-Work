...
class question_twelve(question_thirteen):

    def enter(self):
        print(dedent("""
        Here is your twelve question .
        Q12. who was declared as the winner
        of national award for the best actress
        in 2018 .

        1. sridevi                       2. sonam Kapoor
        3. Tabu                          4. shabana azmi
